...
class EhIcEliminationBatch(models.Model):
    ...
    _unique_pair_period = models.Constraint(
        'unique(company_a_id, company_b_id, period_from, period_to)',
        "An elimination batch already exists for this company pair and "
        "period.",
    )
