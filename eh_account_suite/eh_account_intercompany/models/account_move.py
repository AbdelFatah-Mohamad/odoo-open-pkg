...
class AccountMove(models.Model):
    ...
    _unique_intercompany_mirror = models.Constraint(
        'unique(eh_intercompany_origin_id, company_id)',
        "An inter-company mirror already exists for this source move in "
        "this company.",
    )
