...
##############################################################################
{
    ...
    'summary': 'Quarterly Business Activity Statement worksheet for Odoo 19 Community Australian businesses, with the complete 33-row ATO label set (G, W, T, F, FTC, WET, LCT), a tag-driven single-SQL compute that locks once a run is lodged, GST control-account reconciliation against the 1A and 1B totals, and a mod-89 weighted ABN check-digit validator. Search terms: Odoo 19 Australian BAS, Business Activity Statement Odoo Community, Odoo GST BAS report Australia, ABN validator Odoo, ABN checksum validation, GST control reconciliation, quarterly BAS run, BAS label G1 1A 1B, PAYG withholding W1 W2, Australian tax localization Odoo Community.',
    'description': """The Business Activity Statement is the quarterly tax report Australian businesses lodge with the ATO. This module produces the figures the operator transfers onto the form and keeps a frozen, auditable record of each lodgement, on Odoo 19 Community.
