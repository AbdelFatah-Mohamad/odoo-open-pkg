...
##############################################################################
{
    ...
    'description': """Multi-version budgeting for Odoo 19 Community, built for finance teams that need a versioned, committed, audit-traceable budget without an Enterprise subscription.
