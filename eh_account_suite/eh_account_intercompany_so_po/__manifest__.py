...
##############################################################################
{
    ...
    'summary': 'Extend inter-company automation to sales and purchase orders: confirmed SO drafts PO in partner company and vice versa, building on Inter-Company Rules invoice mirroring. Idempotent, no back-mirroring, Odoo 19 Community.',
