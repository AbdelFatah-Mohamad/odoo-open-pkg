...
##############################################################################
{
    ...
    'summary': 'Self-service accounts receivable for the Odoo 19 Community customer portal. Customers download a period-range statement PDF in one click and see a live open-balance card on their portal home, with no back-office round trip. Odoo 19 customer portal statement download, customer portal account statement PDF, portal AR balance card, self-service customer statement, portal open invoices and overdue summary, accounts receivable portal, partner scoped portal routes.',
    'description': """Customer Portal Extra turns the standard Odoo 19 Community customer portal into a self-service accounts receivable corner. It adds two things and does them carefully.
