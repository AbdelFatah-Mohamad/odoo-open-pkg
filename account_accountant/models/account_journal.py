...
class AccountJournal(models.Model):
    ...
    def action_open_reconcile(self):
        ...
        if self.type in ('bank', 'cash'):
            views = [
                (self.env.ref(
                    'account_accountant.account_bank_statement_line_view_kanban').id,
                 'kanban'),
                (self.env.ref(
                    'account_accountant.account_bank_statement_line_view_tree').id,
            ...
            return {
                ...
                'search_view_id': [
                    self.env.ref(
                        'account_accountant.account_bank_statement_line_view_search').id,
                    'search'],
