...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'account_accountant/static/src/scss/style.scss',
            'account_accountant/static/src/scss/bank_rec_widget.css',
            'account_accountant/static/src/js/bank_reconcile_form_list_widget.js',
            'account_accountant/static/src/js/KanbanController.js',
            'account_accountant/static/src/js/ListController.js',
            'account_accountant/static/src/js/bank_reconcile_form_lines_widget.js',
            'account_accountant/static/src/xml/bank_rec_widget.xml',
            'account_accountant/static/src/xml/bank_reconcile_widget.xml',
        ]
    },
    'license': 'LGPL-3',
