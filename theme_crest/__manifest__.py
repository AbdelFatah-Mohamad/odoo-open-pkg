...
{ 
    'name': 'Theme Crest',
    'summary': """Theme Crest is a modern Odoo theme designed to enhance both backend and website user experience with a clean and professional interface. It provides improved layouts, advanced header and footer designs, responsive ecommerce pages, and enhanced product card UI with additional attributes.""", 
    'description': """Theme Crest is a modern Odoo theme designed to enhance both backend and website user experience with a clean and professional interface. It provides improved layouts, advanced header and footer designs, responsive ecommerce pages, and enhanced product card UI with additional attributes.""",
    'version': '19.0.1.1.1',
    'license': 'OPL-1',
    ...
    "price": "00.0",
    'currency': 'USD',
    'live_test_url': 'https://www.terabits.xyz/request_demo?source=index&version=19.0&app=theme_crest',
}
